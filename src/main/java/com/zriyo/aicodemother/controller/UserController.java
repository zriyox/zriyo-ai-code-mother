...
public class UserController {
    ...
    public BaseResponse<LoginUserVO> userRegister(@Valid @RequestBody UserRegisterRequest userRegisterRequest) {
    ...
    public BaseResponse<LoginUserVO> forgetPassword(@Valid @RequestBody ForgetPasswordRequest forgetPasswordRequest) {
        return ResultUtils.success(userService.forgetPassword(forgetPasswordRequest));
    }
